...
function DetailNews() {
  ...
  return (
    <div className="news__detail container-1">
      <div className="news__detail-content">
        <h1 className="heading-title">Dịch bệnh và lời giải cho không gian sống được hướng tới giới thượng lưu lựa chọn</h1>
        <p>
             Không chỉ thay đổi “khẩu vị” đầu tư, thị trường bất động sản dưới tác động của dịch bệnh đã làm thay đổi định nghĩa về một ngôi nhà lý tưởng và xu hướng lựa chọn nhà của nhiều gia đình, đặc biệt là giới thượng lưu thành đạt. Theo đó, khách hàng đang hướng đến những trải nghiệm sống thời thượng.
             Khi nhu cầu nghỉ dưỡng ngày càng cao, các tiêu chí về chất lượng sống,
             không gian, cảnh quan và hệ tiện ích hiện đại là những yếu tố được nhà đầu tư quan tâm hàng đầu.
        </p>
      </div>
      <div className="news__detail-category">
